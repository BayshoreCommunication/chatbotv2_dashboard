            ...
            <div className="space-y-5">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  {editing ? (
                    <select className="text-gray-900 w-full h-[46px] rounded-xl border border-gray-300 bg-gray-50 px-4 text-sm font-medium focus:border-primary focus:bg-white focus:outline-none focus:ring-4 focus:ring-primary/10 transition-all" value={form.theme.font_family} onChange={(e) => setForm({ ...form, theme: { ...form.theme, font_family: e.target.value } })}>
                  ...
                  <>
                    ...
                    {uploadingImage ? (
                      <div className="flex flex-col items-center gap-3 text-gray-500">
                        <BiRefresh className="animate-spin text-primary" size={36} />
                      ...
                      <div className="flex flex-col items-center gap-3">
                        ...
                        <p className="text-sm font-semibold text-primary-dark bg-white/80 px-3 py-1 rounded-full shadow-sm">Click to replace image</p>
                      </div>
                    ) : (
        ...
        <section className="rounded border border-gray-200 bg-white p-7 shadow-sm">
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            ...
            <div className="flex flex-col justify-center">
              ...
              {editing ? (
                <input type="number" className="text-gray-900 w-full rounded-xl border border-gray-300 bg-gray-50 px-4 py-3 text-sm font-medium focus:border-primary focus:bg-white focus:outline-none focus:ring-4 focus:ring-primary/10 transition-all" value={form.behavior.open_delay} onChange={(e) => setForm({ ...form, behavior: { ...form.behavior, open_delay: parseInt(e.target.value) || 0 } })} />
              ) : (
        ...
        <section className="rounded border border-gray-200 bg-white p-7 shadow-sm">
          ...
          <div className="grid gap-7 xl:grid-cols-2">
            <div className="space-y-5">
              ...
              <div className={`flex items-center justify-between rounded-xl p-4 transition-all ${editing ? "border border-primary/20 bg-primary/5" : "bg-gray-50"}`}>
                <div>
                  <h4 className={`font-semibold text-sm ${editing ? "text-primary-dark" : "text-gray-900"}`}>Show Welcome Message</h4>
                  <p className={`text-xs mt-0.5 ${editing ? "text-primary-dark/80" : "text-gray-500"}`}>Display greeting when chat opens</p>
                </div>
                {editing ? (
                  <label className="relative inline-flex cursor-pointer items-center">
              ...
              <div>
                ...
                {editing ? (
                  <textarea rows={4} className="text-gray-900 w-full resize-none rounded-xl border border-gray-300 bg-gray-50 px-4 py-3 text-sm font-medium focus:border-primary focus:bg-white focus:outline-none focus:ring-4 focus:ring-primary/10 transition-all" value={form.content.welcome_message} onChange={(e) => setForm({ ...form, content: { ...form.content, welcome_message: e.target.value } })} />
                ) : (
              ...
              <div>
                ...
                {editing ? (
                  <input type="text" className="text-gray-900 w-full rounded-xl border border-gray-300 bg-gray-50 px-4 py-3 text-sm font-medium focus:border-primary focus:bg-white focus:outline-none focus:ring-4 focus:ring-primary/10 transition-all" value={form.content.input_placeholder} onChange={(e) => setForm({ ...form, content: { ...form.content, input_placeholder: e.target.value } })} />
                ) : (
            ...
            <div className="flex flex-col h-full">
              <div className="mb-2 flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                  ...
                  {editing ? (
                    <input type="checkbox" className="h-4 w-4 cursor-pointer rounded border-gray-300 text-primary-dark focus:ring-primary" checked={form.content.welcome_video_autoplay} onChange={(e) => setForm({ ...form, content: { ...form.content, welcome_video_autoplay: e.target.checked } })} />
                  ) : (
                    ...
                    {uploadingVideo ? (
                      ...
                      <div className="flex flex-col items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-xs font-semibold text-primary-dark mt-2 bg-white/80 py-1 px-3 rounded-full shadow-sm inline-block">Click to replace video</p>
                        </div>
                      </div>
                    ) : (
                      <div className="flex flex-col items-center gap-2 text-gray-500">
