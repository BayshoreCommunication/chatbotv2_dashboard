...
const caseStudies = [
  {
    ...
    stat: "3.2×",
    description: "increase in tour requests captured from listings during nights and weekends.",
    author: "Prestige Realty Group · 60 days in",
  },
  {
    category: "Rentals",
    stat: "+38%",
    description: "bump in qualified applicant inquiries after adding the widget.",
    author: "Harborview Homes · 45 days in",
  },
  {
    category: "New Construction",
    stat: "-51%",
    description: "drop in time wasted answering the exact same floor plan and pricing questions.",
    author: "Meridian Group · 90 days in",
  },
];
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h2 className="mb-2 text-2xl font-extrabold tracking-tight text-gray-900 sm:text-3xl md:text-4xl lg:text-[42px] leading-snug sm:leading-tight">
            Real numbers from active markets
          </h2>
        </motion.div>
