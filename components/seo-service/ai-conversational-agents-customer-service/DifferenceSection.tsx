...
const comparisonRows = [
  {
    before: "Customers may wait hours or days for a first response.",
    after: "Customers can receive an answer in under two seconds.",
  },
  {
    before: "Representatives repeatedly answer the same questions.",
    after: "Routine questions can be resolved automatically.",
  },
  {
    before: "Messages received outside business hours wait until the next working day.",
    after: "Support remains available during nights, weekends, and holidays.",
  },
  {
    before: "Higher support volume can require additional agents.",
    after: "Support operations can handle higher volumes without adding headcount for every demand increase.",
  },
];
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h2 className="mb-2 text-2xl font-extrabold tracking-tight text-gray-900 sm:text-3xl md:text-4xl lg:text-[42px] leading-snug sm:leading-tight">
            What Changes With Go Converto
          </h2>

          <p className="text-sm leading-relaxed text-gray-600 sm:text-base md:text-lg max-w-3xl">
            The difference shows up in both the customer experience and the work your support team handles each day.
          </p>
        </motion.div>
