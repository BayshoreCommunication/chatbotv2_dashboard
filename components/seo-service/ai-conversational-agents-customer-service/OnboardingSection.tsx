...
import { BsCheckCircleFill, BsClockHistory, BsCodeSquare, BsSearch, BsSliders } from "react-icons/bs";

const onboardingSteps = [
  {
    badge: "Minute 1",
    title: "Submit Your Website & KB URLs",
    description: "Go Converto begins scanning your products, policies, FAQs, and documentation.",
    icon: BsSearch,
  },
  {
    badge: "Minute 5",
    title: "Review the Knowledge Base",
    description: "See what the platform has learned and make corrections before going live.",
    icon: BsSliders,
  },
  {
    badge: "Minute 8",
    title: "Set Your Routing Rules",
    description: "Choose the topics, keywords, or customer sentiment that should send a conversation directly to your team.",
    icon: BsClockHistory,
  },
  {
    badge: "Minute 10",
    title: "Install the Interface",
    description: "Add a single line of code to your website or connect Go Converto with your existing ticketing software.",
    icon: BsCodeSquare,
  },
  {
    badge: "Day 1",
    title: "First Conversation Resolved",
    description: "Most customers see their first fully autonomous resolution within hours of activating the service.",
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h2 className="mb-2 text-2xl font-extrabold tracking-tight text-gray-900 sm:text-3xl md:text-4xl lg:text-[42px] leading-snug sm:leading-tight">
            Know What Happens After You Sign Up
          </h2>

          <p className="text-sm leading-relaxed text-gray-600 sm:text-base md:text-lg max-w-2xl">
            The setup is designed to move quickly, while still giving you time to review the information before the agent goes live.
          </p>
        </motion.div>
