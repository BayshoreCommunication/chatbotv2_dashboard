...
export default function CustomerServiceHero() {
  ...
  useEffect(() => {
    ...
    const startAnimationCycle = () => {
      ...
      timeouts.push(setTimeout(() => startAnimationCycle(), 11000));
    };
          ...
          >
            <div className="mb-6 flex items-center gap-2">
              ...
              <span className="text-xs font-bold uppercase tracking-wider text-[#00a8a0] sm:text-sm">
                Conversational AI Built for Customer Service
              </span>
            </div>
            ...
            <p className="mb-8 max-w-lg text-sm leading-relaxed text-gray-600 sm:text-base md:text-lg">
              Customers usually want one thing from support, a useful answer without a long wait. Go Converto&apos;s AI conversational agents customer service technology learns your products, policies, FAQs, and support processes. It answers customer questions instantly, handles routine requests, and brings your team into the conversation when human help is genuinely needed.
            </p>
            ...
            <div className="relative z-10 rounded-3xl border border-gray-100 bg-white p-5 shadow-xl shadow-teal-900/10 sm:p-6 h-[470px] sm:h-[490px] flex flex-col justify-between overflow-hidden">
              <div className="shrink-0 mb-3 flex items-center justify-between border-b border-gray-100 pb-3 text-xs text-gray-500">
                <div className="flex items-center gap-2">
                  ...
                  <span>A Customer Support Conversation</span>
                </div>
                  ...
                  {chatStep >= 3 && (
                    ...
                    >
                      ...
                      <div className="max-w-[85%] rounded-2xl bg-[#edf5ff] p-3.5 text-xs text-gray-800 sm:text-sm shadow-2xs">
                        Apologies for the delay. I checked order 4821, and it has been held up at the warehouse. I&apos;ve moved it to priority shipping, so it will go out today.
                      </div>
                    </motion.div>
                  )}
              ...
              <div className="mt-4 flex items-center gap-1.5 rounded-lg border border-emerald-200/60 bg-emerald-50 px-3 py-2 text-xs font-medium text-emerald-700">
                ...
                <span>Handled in 38 seconds | Zero tickets generated</span>
              </div>
            </div>
