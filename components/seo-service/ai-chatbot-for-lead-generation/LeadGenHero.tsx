      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-12 lg:gap-12">
          ...
          >
            ...
            <p className="mb-4 max-w-lg text-sm leading-relaxed text-gray-600 sm:text-base md:text-lg">
              A visitor lands on a website with a question. They want an immediate solution for their problem. If nobody answers, the visitor may leave before contacting you.
            </p>
            ...
            <div className="flex flex-wrap items-center gap-2 text-xs font-medium text-gray-600 sm:text-sm">
              ...
              <span>businesses nationwide run on this</span>
              <span className="text-gray-300">·</span>
              <span>14 day free trial</span>
            </div>
          </motion.div>

          {/* RIGHT COLUMN: Live Chat Card Mockup */}
          <motion.div
          ...
          >
            ...
            <div className="relative z-10 rounded-3xl border border-gray-100 bg-white p-5 shadow-xl shadow-teal-900/10 sm:p-6 h-[470px] sm:h-[490px] flex flex-col justify-between overflow-hidden">
              <div className="shrink-0 mb-3 flex items-center justify-between border-b border-gray-100 pb-3 text-xs text-gray-500">
                <div className="flex items-center gap-2">
                  ...
                  <span>live on yoursite.com</span>
                </div>
                ...
                <AnimatePresence mode="popLayout">
                  ...
                  {chatStep >= 1 && (
                    ...
                    >
                      <div className="max-w-[85%] rounded-2xl bg-[#f5f3ee] p-3.5 text-xs text-gray-800 sm:text-sm shadow-2xs">
                        Hi. Do you handle teams of our size? We&apos;re team of 12 people.
                      </div>
                    </motion.div>
                  )}
                  ...
                  {chatStep >= 3 && (
                    ...
                    >
                      ...
                      <div className="max-w-[85%] rounded-2xl bg-[#edf5ff] p-3.5 text-xs text-gray-800 sm:text-sm shadow-2xs">
                        What primary challenge are you trying to solve?
                      </div>
                    </motion.div>
                  )}
                  ...
                  {chatStep >= 4 && (
                    ...
                    >
                      <div className="max-w-[80%] rounded-2xl bg-[#f5f3ee] p-3.5 text-xs text-gray-800 sm:text-sm shadow-2xs">
                        We need help with lead qualification. Mainly filtering out bad inquiries before they hit our calendar.
                      </div>
                    </motion.div>
                  )}
                  ...
                  {chatStep >= 6 && (
                    ...
                    >
                      ...
                      />
                      <div className="max-w-[85%] rounded-2xl bg-[#edf5ff] p-3.5 text-xs text-gray-800 sm:text-sm shadow-2xs">
                        We can set up those screening rules for you. What is the best email to send over a scheduling link?
                      </div>
                    </motion.div>
                  )}
                </AnimatePresence>
              ...
              <div className="mt-4 flex items-center gap-1.5 rounded-lg border border-emerald-200/60 bg-emerald-50 px-3 py-2 text-xs font-medium text-emerald-700">
                ...
                <span>Lead captured · Ready for sales follow up</span>
              </div>
            </div>
            ...
            <div className="mt-4 flex items-center justify-start gap-2 pl-4">
              <svg
                className="h-7 w-10 text-[#00a8a0] shrink-0"
                viewBox="0 0 50 30"
                fill="none"
