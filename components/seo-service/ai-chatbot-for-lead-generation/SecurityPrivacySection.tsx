...
function LockIcon() {
  return (
    <svg className="w-7 h-7 sm:w-8 sm:h-8 text-[#00a8a0]" viewBox="0 0 36 36" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
const securityCards = [
  {
    ...
    description:
      "Lead data and conversations should use appropriate encryption during transmission and storage based on the platform configuration. Businesses should review security controls available for their account and data flow. Encryption settings may vary by product, integration and deployment method.",
  },
  {
    id: "02",
    ...
    title: "Data handling",
    description:
      "Your business should have a clear process for storing, processing, accessing and transferring captured information. Ai Chatbot workflow should match your internal data policies and retention requirements. Team access can also be limited based on role and business need.",
  },
  {
    id: "03",
    ...
    description:
      "Businesses serving regulated or privacy sensitive markets may need specific security and compliance controls. Product documentation should explain supported standards, certifications, data processing options and available administrative controls. Your team can then compare available features with its own compliance requirements.",
  },
  {
    id: "04",
    icon: UserCheckIcon,
    title: "Data control",
    description:
      "Customers should have practical ways to view, export, manage and delete captured lead information when supported by platform. Access controls can limit data management to approved users. Clear retention and deletion practices can also help reduce unnecessary stored information.",
  },
];
      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h2 className="text-3xl font-extrabold tracking-tight text-slate-900 sm:text-4xl md:text-5xl lg:text-[46px] leading-[1.15] max-w-3xl mx-auto">
            Keep lead data controlled & protected.
          </h2>

          <p className="mt-4 mx-auto max-w-2xl text-sm leading-relaxed text-slate-600 sm:text-base md:text-lg font-normal">
            Lead generation involves collecting contact information so visitors and businesses need clear controls over the data involved.
          </p>
        </motion.div>
        ...
        >
          <div ref={trialRef} className="shrink-0 flex flex-col items-center justify-center relative w-36 h-36">
            <svg className="w-36 h-36 transform -rotate-90" viewBox="0 0 120 120">
              <circle cx="60" cy="60" r="50" stroke="#c2e6e3" strokeWidth="1.5" strokeDasharray="3 3" fill="none" />
              <motion.circle
                cx="60"
                cy="60"
                r="50"
          ...
          <div className="flex-1 text-center sm:text-left">
            <h3 className="text-2xl sm:text-3xl font-bold text-slate-900 mb-3 tracking-tight">
              Start capturing leads in a 14 day free trial
            </h3>
            <p className="text-xs sm:text-sm text-slate-600 leading-relaxed font-normal max-w-2xl">
              Every plan comes with a full 14 day free trial. No long term commitment is required during the trial period. Cancel whenever you want before paying bill.
            </p>
          </div>
        </motion.div>
      </div>
