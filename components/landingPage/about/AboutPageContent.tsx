      ...
      <Container>
        ...
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="text-base leading-relaxed text-gray-600 sm:text-lg">
            Most website visitors leave without ever saying a word — not
            because they aren't interested, but because nobody was there to
            answer when they had a question. We built Go Converto so that
            never has to happen again: an AI assistant that learns your
            business automatically, answers your customers instantly, and
            turns everyday visitors into leads and appointments — without
            requiring a developer, a call center, or a single line of code
            from you.
          </p>
        </div>
