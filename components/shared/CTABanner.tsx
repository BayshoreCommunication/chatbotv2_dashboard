...
const CTABanner = ({
  title = "Ready to Stop Losing Visitors? Let’s Live Your ChatBot",
  description = "Ask us anything about plans, setup, or your specific business. We reply within one business day.",
